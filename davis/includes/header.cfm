...
<div class="float-end">
    ...
    <!--- PROFILE --->
    <!--- Only include profile if logged-in --->
    ...
    <!--- Toggle RIGHT BAR (Make sure it is included in index)
    <div class="dropdown d-inline-block">
...
<div>
    ...
    <div class="navbar-brand-box">
        <a href="index.cfm" class="logo logo-dark">
            <span class="logo-sm">
                <img src="#Application.urlPath#/assets/logo_small_white.png" alt="" height="50">
                <!--- <img src="#Application.urlPath#/template/admin/dist/assets/images/logo-sm.png" alt="" height="20"> --->
            </span>
            <span class="logo-lg">
                <img src="#Application.urlPath#/assets/logo_small_white.png" alt="" height="50">
                <!--- <img src="#Application.urlPath#/template/admin/dist/assets/images/logo-dark.png" alt="" height="17"> --->
            </span>
        </a>
        ...
        <a href="index.cfm" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="#Application.urlPath#/assets/logo_small_white.png" alt="" height="50">
                <!--- <img src="#Application.urlPath#/template/admin/dist/assets/images/logo-light.png" alt="" height="19"> --->
            </span>
        </a>
    </div>
